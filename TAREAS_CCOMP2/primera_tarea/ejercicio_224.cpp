/*(par o impar) escriba un programa que lea dos números enteros y determine e imprima si cada número entero, así como la suma de los dos números enteros, es un número impar.
